<template>
  <div class="content-wrap content-wrap-response">
    ...
    <cnode-login
      v-show="$store.state.openLoginCard"
      v-if="isLoginAlive"
    ></cnode-login>
    <!-- 宽度小于900px且移动侧边栏展开时的遮罩层 -->
    <div
      v-show="this.$store.state.showNavside"
...
<script>
import cnodeLogin from "./navSideContent/itemContent/cnodeLogin.vue";
...
<style scoped>
.content-wrap {
  background: url(../assets/img/first-background.jpg);

    ...
    <div v-show="!loading" class="nsc-commonBody">
      <div class="nsc-commonBlockWrp">
        <img
          ...
          class="author-avatar author-avatar-response"
      ...
      <div class="nsc-commonBlockWrp">
        ...
        <div class="nsc-commonBlockBody">
          ...
          <div
            v-show="index < publishTopicShowNum"
          ...
          <div
            @click="showMoreContent('publishTopic')"
            v-if="userInfo.recent_topics.length > 6"
            class="showMoreContent"
          >
            <span v-show="publishTopicShowNum === 5"
      ...
      <div class="nsc-commonBlockWrp">
        <h2>最近参与的话题</h2>
        <div class="nsc-commonBlockBody">
          <span v-if="!userInfo.recent_replies.length"
            >最近没有参与任何讨论</span
          >
          <div
            v-if="userInfo.recent_replies.length"
            v-for="(item, index) in userInfo.recent_replies"
            :key="index"
            class="topicItem"
          >
            <img :src="item.author.avatar_url" :title="item.author.loginname" />
      ...
      <div class="nsc-commonBlockWrp">
        ...
        <div class="nsc-commonBlockBody">
          ...
          <div
            @click="showMoreContent('collect')"
            v-if="userCollect.length > 6"
            class="showMoreContent"
          >
            <span v-show="collectShowNum === 5"
              >查看更多&nbsp;<i class="fa fa-angle-double-right"></i
            ></span>
            <span v-show="collectShowNum > 5"
              >收起&nbsp;<i class="fa fa-angle-double-up"></i

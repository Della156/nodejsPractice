<template>
  <div class="nsc-commonWrp" ref="cnodeTopics">
    ...
    <div
      :class="[
        'topicTabWrp',
        'topicTabWrp-response',
        { 'topicTabWrp-control': !showTabbar }
      ]"
    >
      <div class="tabBar">
        <button
          :disabled="!isTabBarActive"
          @click="selectTab"
          :class="{ tabBarBtnActive: tab.type === currentTab }"
    ...
    <transition name="fade">
      <button v-show="backToTopBtn" @click="backToTop" class="backToTopBtn">
        回到顶部
      </button>
    </transition>
    <!-- 切换tab选项卡时的loading -->
...
export default {
  ...
  beforeRouteEnter(to, from, next) {
    ...
    next(vm => {
      vm.$commonUtil.exchangePageTitle("为何后宫嫔妃要争宠");
